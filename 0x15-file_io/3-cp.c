...
/**
 * create_buffer -this will allocates 1024 bytes to a buffer.
 * @file: name of file buffer is storing chars to.
 *
 ...
 * If file_from  cannot be read or does not close  - exit code 98.
 * If file_to cannot be written  - exit code 99.
 * If file_it  cannot be closed - exit code 100.
 */
